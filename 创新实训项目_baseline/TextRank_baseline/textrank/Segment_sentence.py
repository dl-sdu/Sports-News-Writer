...
class WordSegmentation(object):
    ...
    def __init__(self, stop_words_file = None, allow_speech_tags = libiary.allow_speech_tags): #词性列表，用于过滤
        """
        Keyword arguments:
        ...
        allow_speech_tags = [libiary.as_text(item) for item in allow_speech_tags]
...
class Segment_sentence(object):
    ...
    def __init__(self, stop_words_file = None, 
                    allow_speech_tags = libiary.allow_speech_tags,
                    delimiters = libiary.sentence_delimiters):
        """
        Keyword arguments:
