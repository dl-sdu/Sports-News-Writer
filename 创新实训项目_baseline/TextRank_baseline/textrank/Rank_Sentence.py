...
import numpy as np
from . import libiary
from .Segment_sentence import Segment_sentence

class Rank_Sentence(object):
    
    def __init__(self, stop_words_file = None, 
                 allow_speech_tags = libiary.allow_speech_tags,  #词性列表，用于过滤
                 delimiters = libiary.sentence_delimiters):#分割符
        """
        Keyword arguments:
    ...
    def analyze(self, text, lower = False,
              ...
              sim_func = libiary.get_similarity,
        ...
        self.key_sentences = libiary.sort_sentences(sentences = self.sentences,
                                                 words     = _source,
                                                 sim_func  = sim_func,
